...
const Page = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setStatus(error+"An error occurred while sending the email.");
    }
  };
      ...
      <section className="text-gray-600 body-font relative">
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 bg-cover bg-center bg-[url(/bg.png)] md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            <div className="bg-white relative w-full flex flex-wrap py-6 bg-cover bg-center bg-[url(/bg.png)] rounded shadow-md">
              ...
              <div className="lg:w-1/2 md:px-6 px-2 mt-4 lg:mt-0">
                ...
                <a className="text-indigo-500 text-outline lg:text-lg md:text-[16px] text-[12px] leading-relaxed">
                  rabiasohail1209@gmail.com
                </a>
                <h2 className="title-font font-semibold text-orange-300 text-outline tracking-widest md:text-xl text-lg mt-4">
                  PHONE
                </h2>
                <p className="leading-relaxed text-outline text-green-200">
                  123-456-7890
                </p>
              </div>
            </div>
          ...
          <form
            ...
            className="lg:w-1/3 md:w-1/2 bg-white rounded-lg h-fit bg-cover bg-center bg-[url(/bg.png)] flex flex-col px-8 md:ml-auto w-full md:py-8 mt-8 md:mt-0"
          >
            ...
            <p className="text-sm text-green-200 text-outline mt-3">{status}</p> {/* Show status */}
          </form>
        </div>
      </section>
    </div>
